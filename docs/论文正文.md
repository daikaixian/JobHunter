...
本次毕业设计是对我本人大学四年所受专业教育的一次成果验收。在本次毕业设计的开展过程中，我所使用到的大部分知识都是根据需求现学先用，不断克服一个又一个难点，才有了最终这个系统。这使我愈发的认可“当所学的东西都忘掉之后，剩下的就是教育”这段话，也让我对自己未来的方向有了更清晰的认识，就是要通过不断的学习，不断的突破，不断的解决问题，去达到更高的人生境界。
...
在系统的开发过程中，我遇到过很多各种各样的bug.简单的可能两三分钟就解决了，难一点的有时候可能耗上一整天才解决。在fix bug的过程中，搜索引擎Google和开发者社区StackOverFlow对问题的解决过程提供了很有效的信息。也许大洋彼岸的那些人并不知道他们开发的产品为我带来了多大的便利，但是在这里我也要诚挚的表示对他们的敬意，使他们创造的这么好的产品，给整个互联网界带来了福音，让全世界的科技发展都得到效率的提升，致敬！
